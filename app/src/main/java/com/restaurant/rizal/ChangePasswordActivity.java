...
import com.restaurant.rizal.data.Constants;
import com.restaurant.rizal.model.RegisterResponse;
import com.restaurant.rizal.session.Session;
import com.restaurant.rizal.utils.DialogUtils;
...
public class ChangePasswordActivity extends AppCompatActivity {
    ...
    public void updateUser() {
        ...
        AndroidNetworking.post(Constants.UPDATE_PROFILE_USER + "/" + "rizal").addBodyParameter("nama", name.getText().toString()).addBodyParameter("old_password", oldPass.getText().toString()).addBodyParameter("new_password", newPass.getText().toString()).build().getAsObject(RegisterResponse.class, new ParsedRequestListener() {
            @Override
